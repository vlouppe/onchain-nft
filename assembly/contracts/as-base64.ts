// adapted from https://github.com/near/as-base64
...
export function decode(s: string): Uint8Array {
  ...
  let mainChunk = imax % 4 == 0 ? (imax / 4) * 3 : (imax / 4 + 1) * 3;
  let padSize = pads > 0 ? 3 - pads : 0;
  let size = mainChunk + padSize;
 ...
 */
export function encode(bytes: StaticArray<u8>): string {
  let i: i32;
  let b10: u32;
